...
def generate_pptx():
    ...
    try:
        ...
        return send_file(
            ...
            as_attachment=True,
            download_name=f'{data.get("ticketId", "تقرير")}.pptx'
        )
